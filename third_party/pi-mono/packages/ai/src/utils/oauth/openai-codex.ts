...
async function startOpenAICodexDeviceAuth(
  signal?: AbortSignal,
  fetchImpl: typeof globalThis.fetch = fetch,
...
async function exchangeAuthorizationCodeForCredentials(
  ...
  return credentialsFromToken(
    await exchangeAuthorizationCode(code, verifier, redirectUri, signal, fetchImpl),
  );
}
...
export async function refreshOpenAICodexToken(
  ...
  return credentialsFromToken(await refreshAccessToken(refreshToken, fetchImpl));
}
...
export const openaiCodexOAuthProvider: OAuthProviderInterface = {
  ...
  async refreshToken(
    ...
    return refreshOpenAICodexToken(credentials.refresh, options?.fetch);
  },
