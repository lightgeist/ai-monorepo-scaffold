...
import { TurnContinuationState as TurnContinuationStateView } from "@atlascode/protocol/local";
import type {
  ProcessLocalContext,
...
import { isServerOwnedTurnId } from "@atlascode/shared/turn-identity";
...
async function validateCompactionSession(
  ...
  // record. A main-owned primary Session is still the same Agent as atlascode.
