...
const RESTORED_PROJECT_V5_TRIGGERS_SQL = `
...
export const migration: MigrationEntry = {
  version: 18,
  name: 'restore_project_v5_trigger_compatibility',
  up: restoreProjectV5TriggerCompatibility,
};

function restoreProjectV5TriggerCompatibility(database: MigrationDatabase): void {
  database.exec(`
    ...
    ${RESTORED_PROJECT_V5_TRIGGERS_SQL}
