...
import type { AssemblyResult } from "@atlascode/agent-runtime";
import { createAgentRuntime } from "@atlascode/agent-runtime";
import { sessionReportExtension } from "@atlascode/agent-extension";
import {
...
describe("LocalRuntimeTurnExecutor Agent reference canonical history", () => {
  ...
  it.each([
    ...
    [
      "self",
      "unauthorized",
      { requestRef: "agent:atlascode", displayName: "AtlasCode" },
    ],
  ] as const)(
