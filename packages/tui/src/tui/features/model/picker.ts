...
import type { AtlasCodeCodexOAuthState } from '../../../provider/contract.js';
...
export class TuiModelPicker implements Component, Focusable {
  ...
  constructor(
    ...
    private readonly availability: {
      ...
      codexOAuth?: {
        readonly state: Exclude<AtlasCodeCodexOAuthState, 'hidden'>;
...
function codexOAuthAction(state: Exclude<AtlasCodeCodexOAuthState, 'hidden'>): {
  readonly label: string;
