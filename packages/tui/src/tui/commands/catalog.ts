...
const COMMAND_SOURCES: readonly TuiCommandSource[] = [
  ...
  {
    name: 'changelog',
    description: 'Show the packaged AtlasCode update history',
    category: 'Application',
  },
  {
    name: 'sessions',
  ...
  },
  {
    ...
    discoverability: 'contextual',
    visibleWhen: (context) => context.managedTokenPresent,
    unavailableReason: 'No managed provider account is signed in.',
  },
  {
  ...
  {
    name: 'checkin',
    description: 'Claim the daily managed provider account reward',
    category: 'Application',
    readiness: 'controller',
  ...
  {
    name: 'settings',
    description: 'Configure the AtlasCode terminal interface',
    category: 'Application',
  },
  {
    name: 'statusline',
  ...
  {
    name: 'provider',
    description: 'View providers and edit model credentials',
    category: 'Runtime',
  },
  {
    name: 'plugins',
...
export const ATLASCODE_COMMANDS: readonly TuiCommand[] = DEFAULT_COMMAND_CATALOG.commands;
export const ATLASCODE_ACTIVE_RUN_COMMANDS: readonly TuiCommand[] =
  DEFAULT_COMMAND_CATALOG.activeRunCommands;
export const ATLASCODE_DISCOVERABLE_COMMANDS: readonly TuiCommand[] =
