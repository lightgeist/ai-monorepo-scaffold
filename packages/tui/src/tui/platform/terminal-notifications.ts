...
> = {
  'turn-complete': { title: 'AtlasCode', body: 'Response complete' },
  'permission-required': { title: 'AtlasCode', body: 'Permission needs your input' },
  'question-required': { title: 'AtlasCode', body: 'Question needs your input' },
  'turn-failed': { title: 'AtlasCode', body: 'Response stopped with an error' },
};
...
export function shouldNotifyAtlasCodeTurnComplete(input: {
