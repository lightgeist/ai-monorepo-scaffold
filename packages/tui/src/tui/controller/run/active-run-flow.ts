...
import {
  ...
  ATLASCODE_ACTIVE_RUN_COMMANDS,
  ATLASCODE_COMMANDS,
  ATLASCODE_DISCOVERABLE_COMMANDS,
  type TuiCommand,
...
export function createTuiInitialAutocomplete(
  ...
  builtInCommands: readonly TuiCommand[] = ATLASCODE_DISCOVERABLE_COMMANDS,
) {
...
export function buildTuiSkillCommands(result: TuiSkillList): TuiCommand[] {
  const builtinNames = new Set(
    [...ATLASCODE_COMMANDS, ...ATLASCODE_ACTIVE_RUN_COMMANDS].flatMap((command) =>
...
export class TuiActiveRunFlow {
  ...
  refreshAutocomplete(): void {
    ...
    const builtInCommands = [
      ...(this.commandCatalog?.searchableCommands ?? ATLASCODE_DISCOVERABLE_COMMANDS),
    ];
  ...
  showHelp(): void {
    ...
    const panel = new TuiHelpPanel({
      commands: [
        ...(this.commandCatalog?.discoverableCommands ?? ATLASCODE_DISCOVERABLE_COMMANDS),
      ],
