...
import { ATLASCODE_DARK_THEME, ATLASCODE_LIGHT_THEME } from './palettes.js';
...
let activeColors: TuiThemeColors =
  initialAppearance === 'light' ? ATLASCODE_LIGHT_THEME.colors : ATLASCODE_DARK_THEME.colors;
...
const ATLASCODE_CHALK_MODIFIERS = new Set<TuiChalkModifier>([
  'bold',
  'italic',
  'strikethrough',
  'underline',
  ...
  return new Proxy(target, {
    ...
    get: (_target, property) => {
      ...
      if (
        ...
        ATLASCODE_CHALK_MODIFIERS.has(property as TuiChalkModifier)
      ) {
