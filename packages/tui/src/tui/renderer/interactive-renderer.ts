...
export interface AtlasCodeInteractiveRendererOptions {
...
export class AtlasCodeInteractiveRenderer {
  readonly ui: TUI;
  ...
  constructor(private readonly options: AtlasCodeInteractiveRendererOptions) {
  ...
  private rollbackModeSwitch(options: {
    ...
    captureTuiIncidentBestEffort(this.options.incidentReporter, {
      ...
      codeLocation: 'src/tui/renderer/interactive-renderer.ts#AtlasCodeInteractiveRenderer.switchMode',
      severity: 'error',
