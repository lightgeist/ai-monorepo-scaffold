...
import type { AtlasCodeProviderRuntimePort } from '../provider/contract.js';
import type { AtlasCodePluginRuntimeAccess } from '../plugin/contract.js';
...
export interface TuiConfigurationPort extends AtlasCodeProviderRuntimePort {
...
/**
 * Product-facing Runtime surface required by the interactive AtlasCode TUI.
 *
