...
import { AtlasCodePluginApplication } from '../../src/plugin/application.js';
...
describe('AtlasCodePluginApplication', () => {
  it('partitions installed and available Plugins across the real Runtime sources', async () => {
    ...
    const application = new AtlasCodePluginApplication(port as never);
