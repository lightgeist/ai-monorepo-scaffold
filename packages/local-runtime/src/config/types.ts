import type { AsrConfig, Config, ModelConfig, ProviderAuthMode } from '@atlascode/config';
...
/** BYOK: user's own MiniMax API key (mirrors `MinimaxApiConfig` in @atlascode/config). */
...
/** BYOK: user-created external provider (mirrors `CustomProviderConfig` in @atlascode/config). */
...
export interface LocalRuntimeConfig {
  ...
  /**
   * Not a setting: the fallbacks `@atlascode/config` recorded while parsing the
