import { createDefaultTokenEstimator, type TokenEstimator } from '@atlascode/context-manager';

export const LOCAL_SKILL_CATALOG_MAX_BUDGET_TOKENS = 5_000;
export const LOCAL_SKILL_DESCRIPTION_MAX_CODE_POINTS = 1_024;
const PROTECTED_SKILL_NAMES = new Set(['atlascode-tools-master', 'atlascode-product']);
