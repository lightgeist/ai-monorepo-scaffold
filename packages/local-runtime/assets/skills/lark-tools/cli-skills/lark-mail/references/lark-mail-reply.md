...
- 需要已登录且具备写/读邮件权限（`mail:user_mailbox.message:modify mail:user_mailbox.message:readonly mail:user_mailbox:readonly`）；缺 scope 时按 `cli-skills/lark-shared/SKILL.md` §Agent 代理发起认证 canonical 模板补
