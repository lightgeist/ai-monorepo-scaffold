...
> - `scripts/dotnet/AtlasCodeDocx.Core/Samples/AestheticRecipeSamples*.cs`
>
...
| `scripts/dotnet/AtlasCodeDocx.Core/Samples/AestheticRecipeSamples*.cs` | benchmarked recipe families; choose one instead of inventing values |

## Runtime shorthands

```bash
# macOS / Linux / WSL
CLI="dotnet run --project <skill_dir>/scripts/dotnet/AtlasCodeDocx.Cli --"
