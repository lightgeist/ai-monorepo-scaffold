...
using AtlasCodeDocx.Core.OpenXml;

namespace AtlasCodeDocx.Core.Samples;
...
public static class StyleSystemSamples
{
    ...
    // ────────────────────────────────────────────────────────────────────
    // 7. CJK STYLES (Chinese government documents)
    // ────────────────────────────────────────────────────────────────────

    /// <summary>
    /// Creates Chinese government document styles per GB/T 9704-2012:
    ///   - GongWenTitle: FZXiaoBiaoSong, Chinese size 2 (22pt) — document title
    ///   - GongWenBody: FangSong, Chinese size 3 (16pt) — body text
    ///   - L1Heading: SimHei, Chinese size 3 (16pt) — first-level heading
    ///   - L2Heading: KaiTi, Chinese size 3 (16pt) — second-level heading
    /// </summary>
    /// <remarks>
    /// Chinese font size names to point sizes:
    ///   Chinese initial size = 42pt    small initial size = 36pt
    ///   Chinese size 1 = 26pt    small size 1 = 24pt
    ///   Chinese size 2 = 22pt    small size 2 = 18pt
    ///   Chinese size 3 = 16pt    small size 3 = 15pt
    ///   Chinese size 4 = 14pt    small size 4 = 12pt
    ///   Chinese size 5 = 10.5pt  small size 5 = 9pt
    ///   Chinese size 6 = 7.5pt   small size 6 = 6.5pt
    ///   Chinese size 7 = 5.5pt   size 8 = 5pt
    ///
    /// CJK font usage in government documents:
    ///   FZXiaoBiaoSong-B13S — titles, rarely available; fallback: STZhongsong or SimSun
    ///   FangSong / FangSong_GB2312 — body text
    ///   SimHei — first-level headings (bold-like appearance)
    ///   KaiTi / KaiTi_GB2312 — second-level headings (calligraphic)
    ///   SimSun — fallback for everything
    ///
    ...
    public static void CreateCjkStyles(StyleDefinitionsPart stylesPart)
    {
        ...
        // FZXiaoBiaoSong, Chinese size 2 (22pt), centered, exact line spacing
        ...
        titleStyle.Append(new StyleParagraphProperties(
            ...
            new SpacingBetweenLines
            {
                // Government document titles use exact line spacing, typically ~32pt = 640 DXA
                Line = "640",
        ...
        titleStyle.Append(new StyleRunProperties(
            new RunFonts
            {
                ...
                // FZXiaoBiaoSong is the standard government document title font
                // Fallback: STZhongsong → SimSun
                EastAsia = "方正小标宋简体",
                Ascii = "Times New Roman",
                HighAnsi = "Times New Roman",
                ComplexScript = "Times New Roman"
            },
            // Chinese size 2 = 22pt = 44 half-points
            new FontSize { Val = "44" },
            new FontSizeComplexScript { Val = "44" }
        ));
        stylesPart.Styles.Append(titleStyle);

        // ── Government Document Body Text ──
        // FangSong, Chinese size 3 (16pt), justified, 28pt exact line spacing
        ...
        bodyStyle.Append(new StyleParagraphProperties(
            ...
            new SpacingBetweenLines
            {
                // 28pt line spacing (exact) = 560 DXA, standard for government document bodies
                Line = "560",
                LineRule = LineSpacingRuleValues.Exact,
                Before = "0",
                After = "0"
            ...
            // For Chinese size 3 (16pt): 2 chars ≈ 640 DXA (16pt * 20 DXA/pt * 2)
        ...
        bodyStyle.Append(new StyleRunProperties(
            ...
            // Chinese size 3 = 16pt = 32 half-points
            new FontSize { Val = "32" },
        ...
        // ── Level 1 Heading ──
        // SimHei, Chinese size 3 (16pt), bold by nature of the font
        ...
        l1Style.Append(new StyleRunProperties(
            new RunFonts
            {
                // SimHei — a sans-serif CJK font that looks inherently bold
            ...
            // Same size as body: Chinese size 3 = 16pt
            new FontSize { Val = "32" },
            new FontSizeComplexScript { Val = "32" }
        ));
        ...
        // ── Level 2 Heading ──
        // KaiTi, Chinese size 3 (16pt), also not bold by convention
        ...
        l2Style.Append(new StyleRunProperties(
            new RunFonts
            {
                // KaiTi — calligraphic script font
                EastAsia = "楷体",
                Ascii = "Times New Roman",
                HighAnsi = "Times New Roman"
            },
