...
public static class HeaderFooterSamples
{
    ...
    // ──────────────────────────────────────────────────────────────
    /// <summary>
    /// Adds a Chinese government document style footer:
    ///   - Page number in "-X-" format (e.g., "- 1 -")
    ///   - Centered at bottom
    ///   - SimSun font, 14pt (Chinese size 4)
    ///
    /// XML:
    /// <w:ftr>
    ///   <w:p>
    ...
    ///   Chinese size 4 = 14pt = sz val="28" (half-points)
    ///   Chinese small size 4 = 12pt = sz val="24"
    ///   Chinese size 5 = 10.5pt = sz val="21"
    /// </summary>
    public static void AddChineseGongWenFooter(MainDocumentPart mainPart, SectionProperties sectPr)
    {
        var footerPart = mainPart.AddNewPart<FooterPart>();

        // Common run properties for the footer: SimSun 14pt (Chinese size 4)
        // 14pt = 28 half-points
