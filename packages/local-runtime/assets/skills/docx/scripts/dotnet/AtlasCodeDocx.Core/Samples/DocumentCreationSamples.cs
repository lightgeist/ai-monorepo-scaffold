...
using AtlasCodeDocx.Core.Typography;
...
public static class DocumentCreationSamples
{
        ...
        var runPropsDefault = new RunPropertiesDefault(
            new RunPropertiesBaseStyle(
                ...
                new RunFonts
                {
                    Ascii = "Calibri",
                    HighAnsi = "Calibri",
                    EastAsia = "SimSun",        // SimSun — standard CJK body font
                    ComplexScript = "Arial"
                },
    ...
    public static void SetDocumentProperties(WordprocessingDocument doc)
    {
        ...
        doc.PackageProperties.Creator = "AtlasCode";          // Author
        ...
        {
            Company = new Company("Deep Intuition"),
            Application = new Application("AtlasCodeDocx"),
    ...
    /// A4/Letter sizes, standard/narrow/wide/government-document margins,
    ...
    public static void CreateDocumentWithPageSetup(string path)
    {
        ...
        // ════════════════════════════════════════════════════════════
        // SECTION 4 (FINAL): A4 Portrait with Chinese Government Document Margins
        // ════════════════════════════════════════════════════════════
        ...
        body.Append(
            new SectionProperties(
                ...
                new PageMargin
                {
                    // Government document margins per GB/T 9704-2012
                ...
                // 28 lines per page, 28 characters per line (government document standard)
                new DocGrid
                {
