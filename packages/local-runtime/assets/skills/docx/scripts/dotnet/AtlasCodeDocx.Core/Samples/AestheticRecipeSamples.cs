...
public static partial class AestheticRecipeSamples
{
    ...
    /// - Three-line table: the academic standard — top rule, header rule,
    ...
    /// <summary>
    /// Three-line table: the gold standard for academic data presentation.
    ...
    // ════════════════════════════════════════════════════════════════════════
    // RECIPE 4: CHINESE GOVERNMENT (Official documents, GB/T 9704)
    // ════════════════════════════════════════════════════════════════════════

    /// <summary>
    /// Recipe: Chinese Government Document
    ...
    /// - FangSong_GB2312, Chinese size 3 (16pt): the mandated body font. FangSong is a calligraphic
    ///   style that balances formality with readability in Chinese typography.
    /// - XiaoBiaoSong, Chinese size 2 (22pt): the mandated title font. XiaoBiaoSong is a specialized display
    ...
    public static void CreateChineseGovernmentDocument(string outputPath)
    {
        ...
        // DocDefaults: FangSong 16pt (Chinese size 3), fixed 28pt line spacing
        styles.Append(new DocDefaults(
            new RunPropertiesDefault(
                new RunPropertiesBaseStyle(
                    new RunFonts
                    {
                        // FangSong_GB2312 is the standard; FangSong is the fallback on modern systems
                        Ascii = "FangSong",
                        HighAnsi = "FangSong",
                        EastAsia = "FangSong_GB2312",
                        ComplexScript = "FangSong"
                    },
                    new FontSize { Val = "32" },              // 16pt = Chinese size 3 (in half-points)
        ...
        // ── Title style (XiaoBiaoSong, Chinese size 2, 22pt) ──
        ...
        var titleStyle = new Style(
            ...
            new StyleRunProperties(
                new RunFonts
                {
                    // XiaoBiaoSong is the government standard for titles.
                    // Falls back to STZhongsong or SimSun on systems without it.
                    Ascii = "SimSun",
                    HighAnsi = "SimSun",
                    EastAsia = "FZXiaoBiaoSong-B05S",
                    ComplexScript = "SimSun"
                },
                new FontSize { Val = "44" },              // 22pt = Chinese size 2
        ...
        // ── Heading 2: SimHei, Chinese size 3 (16pt) ──
        // SimHei is the standard sans-serif for first-level section headings.
        var h2Style = new Style(
            ...
            new StyleRunProperties(
                ...
                new FontSize { Val = "32" },              // 16pt = Chinese size 3
                new FontSizeComplexScript { Val = "32" },
                new Color { Val = "000000" }
            )
        )
        ...
        // ── Heading 3: KaiTi, Chinese size 3 (16pt) ──
        // KaiTi for second-level section headings.
        ...
        // ── Caption style ──
        styles.Append(CreateCaptionStyle(
            fontSizeHalfPts: "32",        // Chinese size 3 per standard
            color: "000000",
        ...
        // ── Page numbers: bottom center, "-X-" format, SimSun, Chinese size 4 (14pt) ──
        AddPageNumberFooter(mainPart, sectPr,
            alignment: JustificationValues.Center,
            fontSizeHalfPts: "28",        // 14pt = Chinese size 4
            color: "000000",
            format: PageNumberFormat.DashSurrounded,  // -X- format
            fontName: "SimSun"            // SimSun for page numbers
        );
        ...
        // ── Three-line table (also used in Chinese government documents) ──
        body.Append(CreateThreeLineTable(
            new[] { "项目", "要求", "字体", "字号" },
            new[]
            {
