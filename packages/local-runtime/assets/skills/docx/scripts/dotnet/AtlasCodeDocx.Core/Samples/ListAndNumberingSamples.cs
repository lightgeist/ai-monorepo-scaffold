...
public static class ListAndNumberingSamples
{
    ...
    ///   Level 0: Chinese ideographic numerals one, two, three, followed by an enumeration comma
    ///   Level 1: Chinese ideographic numerals one, two, three in full-width parentheses
    ...
    /// ChineseCountingThousand for Chinese ideographic numeral characters.
        ...
        NumberingDefinitionsPart numPart, Body body)
    {
        ...
        var abstractNum = new AbstractNum(
            // Level 0: Chinese numerals one, two, three with enumeration commas
            // ChineseCountingThousand produces Chinese numerals one through ten
            new Level(
                new StartNumberingValue { Val = 1 },
            ...
            // Level 1: Chinese numerals one, two, three in full-width parentheses
            new Level(
                new StartNumberingValue { Val = 1 },
                new NumberingFormat { Val = NumberFormatValues.ChineseCountingThousand },
