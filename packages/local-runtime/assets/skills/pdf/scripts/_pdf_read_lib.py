...
def cache_dir() -> Path:
    """Return ~/.cache/atlascode/pdf-out/ — the spill destination for outputs
    ...
    """
    return Path.home() / ".cache" / "atlascode" / "pdf-out"
...
def maybe_spill_to_file(content: str, ext: str, max_stdout_bytes: int) -> str:
    """If content > threshold, spill to ~/.cache/atlascode/pdf-out/<hash>.<ext>
...
def add_common_args(p: argparse.ArgumentParser) -> None:
    ...
    p.add_argument(
        ...
        help=(
            ...
            f"~/.cache/atlascode/pdf-out/<hash>.{{md,json}} and only print a "
