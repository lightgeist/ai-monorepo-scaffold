...
> Distilled from the original two-page reference layout (see the AtlasCode illustrative case). Playwright
...
**Case exemplar:** for a complete website-to-brand-guide workflow using the current MiniMax site, real logo asset, portable data-URI source, render command, and verification gates, read [`cases/atlascode-web-brand-guide/README.md`](cases/atlascode-web-brand-guide/README.md). Editable source: [`cases/atlascode-web-brand-guide/source.html`](cases/atlascode-web-brand-guide/source.html).
