...
const MINIAPP_FAILURE_CATALOG = {
  ...
  WORKSPACE_PLUGIN_INVALID: {
    ...
    hint: 'Check .atlascode-plugin/plugin.json and the required package files, then publish again.',
  },
  MINIAPP_REFERENCE_INVALID: {
    ...
    hint: 'For a new package, use atlascode.schemaVersion 2 with atlascode.miniApp set to ./miniapp/miniapp.json. Preserve an existing V1 atlascode.liveboard declaration or transitional V2 atlascode.miniApp declaration when it points to ./liveboard/liveboard.json.',
  },
