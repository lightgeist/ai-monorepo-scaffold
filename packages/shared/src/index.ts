...
export {
  ATLASCODE_BROWSER_EXTENSION_ID,
  getHostName,
  generateManifest,
  serializeManifest,
  getNativeHostDirs,
...
// Owner `<atlascode-thinking>` and `<atlascode-progress>` block helpers — single
...
export {
  ATLASCODE_THINKING_BLOCK_RE,
  ATLASCODE_PROGRESS_BLOCK_RE,
  ATLASCODE_INNERMOST_PAIRED_BLOCK_RE,
  stripAtlasCodeThinkingTags,
  stripAtlasCodeProgressTags,
  stripAtlasCodeTagsForIm,
  extractVisibleContent,
  isThinkingOrProgressOnly,
  isThinkingOnlyContent,
  containsAtlasCodeProgressBlock,
  containsAtlasCodeThinkingBlock,
  containsAtlasCodePairedBlock,
} from './atlascode-tags.js';
...
// ---------------------------------------------------------------------------
// atlascode-widget DSL types — shared contract between daemon (persistence) and
// UI (parsing + rendering).
// ---------------------------------------------------------------------------
export type {
  AtlasCodeWidgetKind,
  AtlasCodeWidgetStreamingMode,
  AtlasCodeWidgetThemeMode,
  AtlasCodeWidgetCapability,
  AtlasCodeWidgetPolicy,
  AtlasCodeWidgetData,
  AtlasCodeWidgetEnvelope,
  WidgetContentSegment,
} from './atlascode-widget-types.js';
