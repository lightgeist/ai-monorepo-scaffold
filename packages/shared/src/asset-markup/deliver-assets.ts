 ...
 *
 * MUST NOT import from `@atlascode/ui` — dependency direction is ui → shared.
 */
...
const SESSION_DELIVERABLE_CANVAS_REFERENCE_PREFIX = 'atlascode-session-deliverable:';
const CANVAS_DELIVERABLE_DIRECTORY = '.atlascode/canvas-assets';
