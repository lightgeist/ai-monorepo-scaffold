...
- The default data directory, `~/.atlascode`, stores login state, provider configuration, and sessions. It is not shareable project configuration. Restrict local access and keep it out of Git.
...
- atlascode-tools obtains short-lived access tokens through the host's lease broker. Never pass refresh tokens to tool processes.
