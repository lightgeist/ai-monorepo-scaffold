---
name: cli-guide
description: Navigate and change the AtlasCode command tree, interactive TUI, headless exec, ACP adapters, or their in-process runtime connection. Use when implementing or debugging CLI behavior in this repository.
---
